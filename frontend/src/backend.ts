...
export class Backend implements backendInterface {
    ...
    async cleanUp(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.cleanUp();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPerUserQuota(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getPerUserQuota(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listUserFiles(arg0: Principal): Promise<Array<FileMetadata>> {
        if (this.processError) {
            try {
                const result = await this.actor.listUserFiles(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeFileReference(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeFileReference(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveFileReference(arg0: string, arg1: ExternalBlob, arg2: string, arg3: bigint, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveFileReference(arg0, await to_candid_ExternalBlob_n13(this._uploadFile, this._downloadFile, arg1), arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
